...
import { Region, Net, BaseInfo, MongodbConfig, Number } from '@/components/OperationCenter/Product/base'
import { IDENTIFIED_KEY, getData, FORM_ICON } from '../base/_constant'
import FormComment from './base/FormComment'

function MongodbForm ({ formProps, batch, resourceData }) {
  return (
    <>
      ...
      <LeftTitle title="配置" icon={FORM_ICON.CONFIG}>
        <MongodbConfig
          {...formProps}
          optionList={getData(resourceData, IDENTIFIED_KEY.NODE_SEPC)}
        />
      </LeftTitle>
