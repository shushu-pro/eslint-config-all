...
class ResourceUsers extends React.Component {
  ...
  render () {
    const {
      form, formItemLayout, label, userList,
    } = this.props
    const {
      dataSource, idList, defautState, definedState,
    } = this.state
    ...
    return (
      ...
      >
        ...
        >
          <a style={{ display: 'inline-block', marginBottom: 15 }}>
        ...
        <Form.Item style={{ marginLeft: 20 }}>{keyDom}</Form.Item>
      </Form.Item>
    )
  }
}
